    ...
    <div className="relative min-h-[100svh] py-16 overflow-hidden">
      ...
      <div className="relative mx-auto w-[min(640px,92vw)] space-y-10">
        <header className="rounded-3xl border border-white/10 bg-white/5 shadow-soft px-6 py-8 text-center">
          <div className="relative mx-auto mb-5 h-20 w-20 overflow-hidden rounded-full border border-white/20 bg-white/10">
            <Image src={socialIconSrc} alt="JOSÉ icon" fill sizes="80px" className="object-cover" />
          </div>
              ...
              >
                ...
                <div className="relative flex items-center gap-4">
                  <div className="relative h-12 w-12 overflow-hidden rounded-xl bg-white/10">
                    <Image src={socialIconSrc} alt={`${link.label} icon`} fill sizes="48px" className="object-cover" />
                  </div>
